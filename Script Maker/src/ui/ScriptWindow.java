...
public class ScriptWindow extends JFrame {
	...
	public ScriptWindow(ScriptConverter scriptCon) {
		...
		final Action readAction = new AbstractAction("Select script to read", new ImageIcon("images/Open.gif")) {
		...
		final Action writeAction = new AbstractAction("Select folder to save to", new ImageIcon("images/Open.gif")) {
			public void actionPerformed(ActionEvent e) {
		...
		final Action closeAction = new AbstractAction("Clear Selected Files", new ImageIcon("images/Undo.gif")) {
			public void actionPerformed(ActionEvent e) {
		...
		final Action convertAction = new AbstractAction("Convert Script to Code", new ImageIcon("images/filesave.gif")) {
			public void actionPerformed(ActionEvent e) {
